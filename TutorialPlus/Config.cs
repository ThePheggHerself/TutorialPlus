...
namespace TutorialPlus
{
	public class Config
	{
		...
		[Description("Automatically enable godmode when a player spawns as tutorial (Will also automatically disable if a player changes role)")]
		public bool TutorialGodmode { get; set; } = true;
		[Description("Automatically enable bypass mode when a player spawns as tutorial (Will also automatically disable if a player changes role)")]
